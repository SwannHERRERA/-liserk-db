...
use tower_http::{
    ...
    propagate_header::PropagateHeaderLayer, sensitive_headers::SetSensitiveHeadersLayer,
    trace,
};
...
pub async fn create_app() -> Router {
    ...
    models::sync_indexes().await.expect("Failed to sync database indexes");
    ...
    Router::new()
        ...
        .merge(Router::new().nest(
            ...
            Router::new().merge(routes::user::create_route()),
        ))
